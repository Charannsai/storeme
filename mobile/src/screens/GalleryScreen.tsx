...
export default function GalleryScreen() {
    ...
    const renderHeader = () => (
        <View style={styles.listHeader}>
            ...
            {!selectMode && trashCount > 0 && (
                <TouchableOpacity style={styles.trashBanner} activeOpacity={0.8} onPress={() => navigation.navigate('TrashBin')}>
                    <View style={styles.trashBannerLeft}>
                        <View style={styles.trashIconBg}>
                            <Feather name="trash-2" size={16} color="#EF4444" />
                        </View>
                        <Text style={styles.trashBannerText}>Recently Deleted</Text>
                    </View>
                    <View style={styles.trashBannerRight}>
                        <Text style={styles.trashBannerCount}>{trashCount}</Text>
            ...
            <Modal visible={menuVisible} transparent animationType="fade" onRequestClose={() => setMenuVisible(false)}>
                <TouchableOpacity style={styles.menuOverlay} activeOpacity={1} onPress={() => setMenuVisible(false)}>
                    <View style={styles.menuContainer}>
                        ...
                        <TouchableOpacity style={styles.menuItem} onPress={() => { setMenuVisible(false); setCreateFolderVisible(true); }}>
                            <Feather name="folder-plus" size={18} color="#1E293B" />
                        ...
                        <TouchableOpacity style={styles.menuItem} onPress={() => { setMenuVisible(false); navigation.navigate('TrashBin'); }}>
                            <Feather name="trash-2" size={18} color="#EF4444" />
                            <Text style={[styles.menuItemText, { color: '#EF4444' }]}>Recycle Bin</Text>
                        </TouchableOpacity>
                    </View>
                </TouchableOpacity>
            </Modal>
